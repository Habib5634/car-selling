        ...
        {/* Transparent Overlay */}
                ...
                <div className='grid grid-cols-1 h-full md:grid-cols-2'>
                    <div className='flex flex-col h-full justify-center items-start md:items-start'>
                        ...
                        <p data-aos="fade-up" data-aos-duration="1000" className='text-white text-start mt-5 text-[15px] md:text-[18px] font-semibold'>There are many variations of passages orem psum available but the majority <br /> have suffered alteration in some form by injected humors.</p>
