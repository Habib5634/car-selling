...
const ProfileMenu = () => {
  ...
  return (
    <div className=''>
      ...
      <FaRegUserCircle className=' hover:text-red anim3 cursor-pointer'   onClick={handleLogout}/>
      ...
      <div className={`${openMenu ? 'min-h-full p-3 shadow-shad':'h-0 overflow-hidden'}  absolute right-0 rounded-lg flex flex-col gap-2 items-start !z-50 bg-white w-full max-w-[150px] anim3`}>
       <Link href={'/profile'}> <button className=' text-black'>Profile</button></Link>
