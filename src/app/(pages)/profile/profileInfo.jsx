    ...
    <div>
      <form action="" className='flex flex-col gap-5'>
        <div className='flex flex-col gap-3'>
          <label htmlFor="name" className='text-20 font-bold text-blackish'>First Name</label>
          <input
            type="text"
            name="firstName"
        ...
        <div className='flex flex-col gap-3'>
          <label htmlFor="Contact" className='text-20 font-bold text-blackish'>lastName</label>
          <input
            type="text"
            name="lastName"
...
<button className='py-2.5 px-3 w-fit bg-purple text-white rpunded-md'>Add</button>
      ...
      <button
          ...
          className="mt-5 py-2 px-4 bg-red text-white rounded-md"
        >
          Update Password
        </button>
        {isModalOpen && 
